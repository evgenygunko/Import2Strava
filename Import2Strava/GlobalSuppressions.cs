...
[assembly: SuppressMessage("Reliability", "CA2008:Do not create tasks without passing a TaskScheduler", Justification = "<An example of code by Google>", Scope = "member", Target = "~M:Import2Strava.Services.AuthenticationService.AuthenticateAsync~System.Threading.Tasks.Task")]
...
[assembly: SuppressMessage("Performance", "CA1835:Prefer the 'Memory'-based overloads for 'ReadAsync' and 'WriteAsync'", Justification = "<An example of code by Google>", Scope = "member", Target = "~M:Import2Strava.Services.AuthenticationService.PerformCodeExchangeAsync(System.String)~System.Threading.Tasks.Task")]
